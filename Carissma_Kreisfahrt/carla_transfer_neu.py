...
def spawn_vehicle_at_vector(world, blueprint_library, vector):
    ...
    spawn_point = carla.Transform(
        ...
        carla.Rotation(yaw=(float(vector[3])/3.14)*180, roll=float(float(vector[4])/3.14)*180, pitch=(float(vector[5])/3.14)*180)
    )
...
def teleport_vehicle_to_vector(vehicle, vector):
    ...
    new_rotation = carla.Rotation(yaw=(float(vector[3])/3.14)*180, roll=float(float(vector[4])/3.14)*180, pitch=(float(vector[5])/3.14)*180)
